...
{
    const char* pszTimestamp = "Test123";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1513525517, 2084524493, 0x1e0ffff0, 1, 50 * COIN);
...
// fill with genesis block 
        ...
        chainTxData = ChainTxData{
            ...
            1513525517, // * UNIX timestamp of last known number of transactions
